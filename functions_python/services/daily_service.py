        ...
        try:
            ...
            if h_doc.exists:
                ...
                if history_points > 0:
                    ...
                    # HISTORY CHECK
                    if (
                        history_points >= HISTORY_MIN_POINTS
                        and years_span >= HISTORY_MIN_YEARS
                    ):
                        history_ok = True
            ...
            if history_ok:
                ...
                perf_update = {"data_quality.std_perf_ok": False}
            ...
            if (eq >= 90.0) and history_ok and (not is_hedged):
                valid_candidates.append(
                    {"isin": isin, "name": f_data.get("name"), "sharpe": current_sharpe}
                )
