...
class FinancialEngine:
    ...
    def optimize_efficient_frontier(
        mu, S, constraints: dict | None = None, exposures_v2: dict | None = None, gamma=0.0
    ):
        """
        ...
        if constraints:
            ...
            if exposure_limits and exposures_v2:
                FinancialEngine.build_exposure_constraints(
                    ef, ef.tickers, exposures_v2, exposure_limits
                )
