...
STATUS: ACTIVE
CATEGORY: audit
PURPOSE: Auditoría detallada de la clasificación V2 y exposición de cartera.
SAFE_MODE: READ_ONLY
...
# âââ AUDIT FLAGS âââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
...
def compute_audit_flags(data: dict) -> list:
    ...
    # ââ Low risk safety checks ââ
    if is_suitable_low:
        ...
        # Funds NOT low-risk suitable â also flag dangerous ones in high risk bucket
...
def run_audit(limit: int = 0):
    ...
    for doc in funds_stream:
        ...
        # ââ Categorize into CSV buckets ââ
