...
def audit_unknowns_v2(input_csv):
    ...
    if not df_unknowns.empty:
        ...
        print("-" * 60)
        print("✅ Lista completa exportada a: fondos_para_revisar.csv")
    else:
        print(
            "🤔 Sigo sin encontrar nada. ¿Seguro que 'categoria_inferida' es la columna que usa tu gráfica?"
        )
