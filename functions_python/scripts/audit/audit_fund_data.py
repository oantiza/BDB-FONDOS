...
STATUS: ACTIVE
CATEGORY: audit
PURPOSE: Auditoría general de datos de fondos en Firestore.
SAFE_MODE: READ_ONLY
            ...
            report.append(
                {
                    "isin": isin,
                    "name": name,
                    "issue": "HISTORY_TOO_SHORT_OR_INVALID",
                    ...
                    report.append(
                        {
                            "isin": isin,
                            "name": name,
                            "issue": "METRIC_MISMATCH_DD",
                            "stored": stored_dd,
                            "calculated": calc["max_drawdown"],
                            "diff": diff,
                        }
                    )
                    ...
                    report.append(
                        {
                            "isin": isin,
                            "name": name,
                            "issue": "METRIC_MISMATCH_VOL",
                            "stored": stored_vol,
                            "calculated": calc["volatility"],
                            "diff": diff,
                        }
                    )
        else:
