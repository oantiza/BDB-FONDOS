...
STATUS: ACTIVE
CATEGORY: fixes
PURPOSE: Rutina de corrección masiva de inconsistencias de datos.
...
def run_fix():
    ...
    if processed_isins:
        ...
        pd.DataFrame({"isin": processed_isins}).to_csv(
            "fixed_anomalies.csv", index=False
        )
