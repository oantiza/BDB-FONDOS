...
def sync_to_firestore(input_csv, dry_run=True):
    ...
    if dry_run:
        print("💡 Esto fue un simulacro. Usa el script sin --execute para aplicar cambios.")

if __name__ == "__main__":
    parser = argparse.ArgumentParser()
    parser.add_argument("--input", default="funds_100_percent_classified.csv")
    parser.add_argument("--execute", action="store_true", help="Escribe los cambios en Firestore")
