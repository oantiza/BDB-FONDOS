...
STATUS: ACTIVE
CATEGORY: reports
PURPOSE: Inserta reportes ficticios para pruebas de UI.
    ...
    data = {
        ...
        "market_pulse": {
            "currencies": {
                "focus": "EUR/USD",
                "trend": "BEARISH",
                "note": "El dólar se fortalece ante datos de empleo robustos.",
            },
            "commodities": {
                "focus": "Brent Oil",
                "trend": "BULLISH",
                "note": "Tensiones en Oriente Medio impulsan el barril.",
            },
            "gold_metals": {
                "focus": "Gold",
                "trend": "NEUTRAL",
                "note": "Consolidación tras máximos históricos.",
            },
        }
        ...
        "model_portfolio": [
            {
                "asset_class": "Renta Variable Global",
                "region": "DM",
                "view": "Sobreponderar",
                "weight": 30,
                "rationale": "Calidad y crecimiento.",
            },
            {
                "asset_class": "Renta Variable Emergente",
                "region": "EM",
                "view": "Neutral",
                "weight": 10,
                "rationale": "Oportunidades selectivas.",
            },
            {
                ...
                "view": "Neutral",
                "weight": 25,
                "rationale": "Preservación de capital.",
            },
            {
                "asset_class": "Activos Alternativos",
                "region": "Global",
                "view": "Sobreponderar",
                "weight": 10,
                "rationale": "Diversificación.",
            },
            {
                "asset_class": "Capital Privado",
                "region": "Global",
                "view": "Neutral",
                "weight": 5,
                "rationale": "Tecnología disruptiva.",
            },
            {
                "asset_class": "TIPS",
                "region": "Global",
            ...
            },
            {
                ...
                "view": "Infraponderar",
                "weight": 15,
                "rationale": "Liquidez táctica.",
            },
        ]
        if report_type == "MONTHLY_PORTFOLIO"
        else None,
    }
