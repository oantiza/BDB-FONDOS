...
class MockCollection:
    def add(self, data):
        ...
        print("\n" + "="*50)
        print("✅ Reporte exitosamente generado por la IA (No guardado en Base de Datos por ser test local)")
...
def main():
    ...
    try:
        ...
        print("⚠️ Pasando a modo 'Mock Database' para probar la IA sin guardar en BD...\n")
        db = MockDB()
