...
def main():
    ...
    for doc in docs:
        ...
        data_summary['classification_v2.asset_type'][str_hashable(classification.get('asset_type', 'MISSING'))] += 1
        data_summary['classification_v2.asset_subtype'][str_hashable(classification.get('asset_subtype', 'MISSING'))] += 1
        data_summary['classification_v2.region_primary'][str_hashable(classification.get('region_primary', 'MISSING'))] += 1
        
        data_summary['derived.asset_class'][str_hashable(derived.get('asset_class', 'MISSING'))] += 1
        data_summary['derived.category'][str_hashable(derived.get('category', 'MISSING'))] += 1
        data_summary['derived.style'][str_hashable(derived.get('style', 'MISSING'))] += 1
        data_summary['derived.quality'][str_hashable(derived.get('quality', 'MISSING'))] += 1
        
        data_summary['portfolio_exposure_v2.economic_exposure'][str_hashable(exposure.get('economic_exposure', 'MISSING'))] += 1
