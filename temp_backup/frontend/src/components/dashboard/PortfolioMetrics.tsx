...
// Removed: calculateCovarianceMatrix import - it uses yearly % as if daily prices, producing 68% volatility
...
export default function PortfolioMetrics({
    ...
    // BUG FIX: Removed localCovMatrix - calculateCovarianceMatrix treats yearly % returns
    // (e.g. 15%, 8%) as daily NAV prices and computes derivatives between them,
    // resulting in mathematically invalid 68%+ volatility.
    const localCovMatrix = null;
    ...
    const metrics = useMemo(() => {
        ...
        const stats = calcSimpleStats(portfolio, riskFreeRate, null);
        return {
            vol: stats.vol,
            sharpe: stats.sharpe,
    ...
    }, [portfolio, riskFreeRate, historyData, xrayMetrics]);
