...
def trim_fund():
    ...
    print(
        f"✂️ Recortando histórico de {isin} para descartar datos previos al {cut_date}..."
    )
    ...
    print(
        f"✅ {isin} actualizado. Puntos antiguos: {len(history)} -> Puntos limpios: {len(clean_history)}"
    )
