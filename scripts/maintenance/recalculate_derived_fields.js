 ...
 * PURPOSE: Recalculate derived.* fields in funds_v3 based on existing Morningstar data without requiring PDFs.
 * SAFE_MODE: MUTATES_FIRESTORE
 * RUN: node scripts/maintenance/recalculate_derived_fields.js
 */
/**
