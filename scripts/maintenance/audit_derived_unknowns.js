 ...
 * PURPOSE: Audit funds_v3 collection to find unknown subtypes or class/subtype inconsistencies. Exports results to CSV.
 * SAFE_MODE: READ_ONLY
 * RUN: node scripts/maintenance/audit_derived_unknowns.js
 */
/**
