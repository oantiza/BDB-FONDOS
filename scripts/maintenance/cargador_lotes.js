 ...
 * PURPOSE: Multi-threaded PDF parser using Gemini AI to extract fund data and populate/update funds_v3 in Firestore.
 * SAFE_MODE: MUTATES_FIRESTORE
 * RUN: node scripts/maintenance/cargador_lotes.js
 */
/**
