...
STATUS: ACTIVE
CATEGORY: repo
PURPOSE: Create a clean source code backup, specifically excluding node_modules, .venv, and other non-source directories. Includes installation notes.
SAFE_MODE: LOCAL_ONLY
RUN: python scripts/repo/create_project_backup.py
"""
import os
import zipfile
import datetime
...
def create_clean_zip():
    ...
    EXCLUDE_DIRS = {
        ...
        'coverage', 'cypress', 'logs', '.antigravity', '.agent', '.gemini'
    }
