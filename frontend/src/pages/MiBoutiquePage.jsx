                    ...
                    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
                        ...
                        <div className="bg-white rounded-lg border border-slate-200 shadow-sm overflow-hidden">
                            <div className="p-2 border-b border-gray-200 bg-gray-50">
                                <h3 className="font-sans font-bold text-gray-700 text-xs uppercase tracking-wider">
                                    1. Resumen Ejecutivo (The Bottom Line)
                                </h3>
                            </div>
                            <div className="p-6 text-sm leading-relaxed text-gray-700 text-justify font-light whitespace-pre-line">
                        ...
                        <section className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <div className="bg-white rounded-lg border border-slate-200 shadow-sm overflow-hidden">
                                <div className="p-2 border-b border-gray-200 bg-gray-50 flex justify-between items-center">
                                    <h3 className="font-sans font-bold text-gray-700 text-xs uppercase tracking-wider">Dinámica Monetaria</h3>
                                    <span className="text-[9px] text-gray-400 uppercase font-bold tracking-widest">Tasas vs IPC</span>
                                </div>
                                <div className="p-4">
                            ...
                            <div className="bg-white rounded-lg border border-slate-200 shadow-sm overflow-hidden">
                                <div className="p-2 border-b border-gray-200 bg-gray-50 flex justify-between items-center">
                                    <h3 className="font-sans font-bold text-gray-700 text-xs uppercase tracking-wider">Divergencia Crecimiento 2025</h3>
                                    <span className="text-[9px] text-gray-400 uppercase font-bold tracking-widest">PIB Real (%)</span>
                                </div>
                                <div className="p-4">
