...
export type ConstraintObjective =
    | 'efficient_risk'
    | 'max_sharpe'
    | 'min_vol'
    | 'target_return';

export type LockMode = 'keep_weight' | 'keep_money' | 'min_keep' | 'free';
...
export interface BucketBoundsV1 {
    equity?: BoundRange;
    bond?: BoundRange;
    cash?: BoundRange;
    alternative?: BoundRange;
    real_asset?: BoundRange;
    other?: BoundRange;
}

export interface ConstructionRulesV1 {
    min_weight?: number;
    max_weight?: number;
    cutoff?: number;
}

export interface LockRulesV1 {
    mode: LockMode;
    positions: Record<string, number>;
}

export interface TacticalViewsV1 {
    by_isin?: Record<string, number>;
}

export interface ConstraintFlagsV1 {
    apply_profile?: boolean;
    strict_feasibility?: boolean;
}

export interface PortfolioConstraintsV1 {
    version: '1.0';
    profile_id: string;
    optimization_mode: string;
    objective: ConstraintObjective;
    risk_budget: RiskBudgetV1;
    bucket_bounds: BucketBoundsV1;
