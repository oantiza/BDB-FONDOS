...
export const PositionsAnalyzer: React.FC<PositionsAnalyzerProps> = ({ onBack, assets }) => {
        ...
        if (rawData.length > 0) {
            ...
            rawData.forEach(row => {
                ...
                if (isin && isin.length > 5) {
                    ...
                    if (foundFund) {
                        fundFound = true;
                        retrocession = foundFund.costs?.retrocession || 0;
                    }
    ...
    return (
        <div className="min-h-screen bg-slate-50 text-slate-900 font-sans">
            ...
            <header className="bg-slate-900 text-white shadow-lg border-b border-slate-800 mb-8 sticky top-0 z-50">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        {onBack && (
                            ...
                            >
                                <ArrowLeft className="w-4 h-4" /> TRADING DESK
                            </button>
                        )}
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <h1 className="text-lg font-semibold tracking-tight text-white">Analizador de Posiciones</h1>
                        </div>
                    </div>
                    {hasData && (
                        <button
