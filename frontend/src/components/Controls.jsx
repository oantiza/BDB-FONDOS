                    ...
                    <div>
                        ...
                        <div className="flex gap-1">
                            <select
                                ...
                                className="w-1/2 text-[10px] bg-slate-200 border-none rounded px-2 py-1 outline-none text-slate-700"
                            >
                            ...
                            <button
                                onClick={onOpenVip}
                                className="w-1/2 text-[10px] bg-white border border-slate-200 hover:bg-slate-50 text-slate-600 px-1.5 rounded transition-colors"
                                title="Configurar Fondos VIP (Ancla)"
                            >
                                ⚓ VIP
                            </button>
                        </div>
