    ...
    return (
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4 backdrop-blur-sm font-sans">
            <div className="bg-white rounded-xl shadow-2xl w-full h-[95vh] max-w-7xl flex flex-col overflow-hidden border border-slate-200">
                ...
                {/* 1. Header (Title Only) */}
                <div className="bg-white border-b border-slate-200 shrink-0 h-12 flex justify-between items-center px-6">
                    <h2 className="text-lg font-bold text-[#0B2545] flex items-center gap-2">
                        <span className="text-xl">⚖️</span> Tactical Optimization Review
                    </h2>
