...
export function RetirementSummaryCard({ results }: { results: RetirementResults }) {
    ...
    return (
        <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-8 relative overflow-hidden">
            <h2 className="text-3xl font-black text-[#0B2545] mb-2 tracking-tight">Renta Mensual Neta Estimada</h2>
            <p className="text-sm text-slate-500 mb-8 font-medium">Neto real tras aplicar IRPF (Pensión Pública Neta + Renta Privada Neta)</p>

            <div className="flex flex-col md:flex-row md:items-end gap-6 mb-10">
                <div>
                    <span className="text-6xl font-black text-[#0B2545] tracking-tighter">
                        {formatCurrency(rentTaxResult.netoConsolidadoMensual)}
                    </span>
                    <span className="text-slate-500 font-medium ml-3 text-lg">/ mes netos reales</span>
                </div>
            </div>
            ...
            <div className="bg-[#0B2545]/5 p-6 rounded-xl border border-[#0B2545]/10 mt-6 md:mt-0 text-base md:text-lg text-slate-700 leading-relaxed">
                <p>
