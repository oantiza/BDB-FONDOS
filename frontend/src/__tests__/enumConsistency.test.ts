...
const BACKEND_ASSET_SUBTYPE_V2 = [
  ...
  'SECTOR_EQUITY_TECH', 'SECTOR_EQUITY_HEALTHCARE', 'SECTOR_EQUITY_FINANCIALS',
  'SECTOR_EQUITY_INDUSTRIALS', 'SECTOR_EQUITY_CONSUMER_CYCLICAL',
  'SECTOR_EQUITY_CONSUMER_DEFENSIVE', 'SECTOR_EQUITY_REAL_ESTATE',
  'SECTOR_EQUITY_UTILITIES', 'SECTOR_EQUITY_ENERGY',
  'SECTOR_EQUITY_BASIC_MATERIALS', 'SECTOR_EQUITY_COMMUNICATION',
  'THEMATIC_EQUITY',
  ...
  'FLEXIBLE_ALLOCATION', 'MULTI_ASSET_INCOME', 'TARGET_DATE', 'MONEY_MARKET',
  'UNKNOWN',
];
